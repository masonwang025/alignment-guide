...
const Button = ({ text, darker }: { text: string; darker?: boolean }) => {
	return (
		<div
			...
			} text-black !no-underline md:text-lg font-light hover:font-normal hover:font-serif hover:italic hover:md:text-xl hover:text-lg hover:tracking-wide py-3 px-6 rounded-2xl transition-shadow duration-200`}
		>
