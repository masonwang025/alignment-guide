	...
	return (
		<div
			className={`${
				...
				darker
					? 'bg-primary-300 shadow-[0.625rem_0.625rem_0.875rem_0_rgb(200,200,200),-0.5rem_-0.5rem_1.125rem_0_rgb(255,255,255)] hover:shadow-[inset_0.2rem_0.2rem_0.5rem_rgb(200,200,200),inset_-0.2rem_-0.2rem_0.5rem_rgb(255,255,255)]'
