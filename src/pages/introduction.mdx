...
import circlesMobile from '../assets/circles-mobile.png';

# Introduction

<div className='relative'>
	<Image src={circles} alt='Circles Graphic' className='hidden sm:block' />
	<Image src={circlesMobile} alt='Circles Graphic Mobile' className='block sm:hidden' />
</div>
