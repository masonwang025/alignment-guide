...
<CustomAlert title="This section is incomplete" variant="warning" description="As we fill out the rest of the guide, we'll be updating this section with which pages you should start with and visit next (based on what you're looking for)." />
