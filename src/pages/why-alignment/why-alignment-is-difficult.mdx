...
<Toggle title='Sources and resources' className='px-4 bg-accent-400 rounded-xl mt-10'>
    1. Leopold Aschenbrenner's essay on [Superalignment](https://situational-awareness.ai/superalignment/) dives deeper into the the unsolved technical problem of reliably controlling AI smarter than us. 2. The teacup example and
    general framing on this page comes from Robert Mile's [Intro to AI Safety](https://www.youtube.com/watch?v=pYXy-A4siMw).
</Toggle>
