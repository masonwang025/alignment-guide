...
<Toggle title={<div class="font-bold">Because it’s difficult to choose good goals.</div>}>
...
<Toggle title="Sources and resources" className="px-4 bg-accent-400 rounded-xl">
1. The next read we recommend is Leopold Aschenbrenner's essay on [Superalignment](https://situational-awareness.ai/superalignment/), where he dives deep into the the unsolved technical problem of reliably controlling AI smarter than us.
2. The chart, teacup example, and general framing above comes from Robert Mile's [Intro to AI Safety](https://www.youtube.com/watch?v=pYXy-A4siMw).
</Toggle>
