...
1. AGI is [being projected](https://www.dwarkeshpatel.com/p/dario-amodei) for 2029, and <span className="highlight">it’s a realistic prediction.</span>
...
2. AGI has **no reason** to plateau at human-level intelligence. In fact, we believe it would shoot right past it very, very quickly: <span className="highlight">A system more intelligent than all of humanity could emerge within **days or years** after we hit AGI.</span> The **takeoff to superintelligence will be short.**
...
3. <span className='highlight'>We have **one chance** to solve AI alignment.</span> Once a misaligned AGI exists, our fate would be sealed.
   <Toggle
       title={
           <div>
               Sufficiently intelligent AI systems will possess <strong>instrumental convergent goals</strong> (<LinkBadge text='Why is alignment difficult?' link='/why-alignment/why-alignment-is-difficult' />
