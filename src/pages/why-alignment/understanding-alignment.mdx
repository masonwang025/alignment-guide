...
<div>
  ...
  the **alignment** problem is about <span className="bg-highlight">building AI systems that are trying to
    do what their operator wants them to do</span>. In other words, AI alignment aims to
