...
<p><span className="font-bold">Why should a superintelligent AI concern you any more than the fact that mechanical vehicles can go faster than a human can run?</span></p>
...
<p><span className="font-bold">How could a computer program gain or wield power?</span></p>
...
<p><span className="font-bold">Wouldn’t a superintelligent AI be smart enough to use its power responsibly?</span></p>
...
1. Robert Miles provides great introductions to instrumental convergence in [Why Would AI Want to do Bad Things?](https://www.youtube.com/watch?v=ZeecOKBus3Q) and the orthongality thesis in [Intelligence and Stupidity](https://www.youtube.com/watch?v=hEUO6pjwFOo&lc=UgzWZ_bUKbKohc0gK3V4AaABAg).
2. For a comprehensive and in-depth understanding of these two concepts, see Arbital's docs on [instrumental convergence](https://arbital.com/p/instrumental_convergence/) and [orthogonality](https://arbital.com/p/orthogonality/).
</Toggle>
